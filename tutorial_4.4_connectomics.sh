...
# [FreeSurfer Version]
# export SUBJECTS_DIR=.
# recon-all -s sub-01 -i bids_data/sub-01/ses-01/anat/t1.nii.gz -all
# mri_convert sub-01/mri/aparc+aseg.mgz aparc+aseg.nii.gz
...
# [MRtrix Version]
tck2connectome wb_250k.tck synthseg_relabeled_nodes.nii.gz connectome.csv -out_assignments assignments.txt

# [scilpy Version] (multi-step)
# scil_tractogram_segment_connections_from_labels wb_250k.tck aparc+aseg.nii.gz connections.h5
...
# # Step 3: QC Step: Inspect the Matrix
echo "Step 3: QC Step: Inspect the Matrix..."
# [MRtrix Version]
mkdir connections/
connectome2tck wb_250k.tck assignments.txt connections/edge-
...
# # Step 4: Visualize the connectome
echo "Step 4: Visualizing the connectome..."
